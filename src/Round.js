    ...
    render() {
        ...
        if (this.props.courts && this.props.showTenCourts && this.props.courtsToUse && this.props.courts.length <= this.props.courtsToUse.length) {
            ...
            courts = this.props.courts.map((teamsOnCourt, index) =>
                <Court teams={teamsOnCourt} key={index} courtNumber={(this.props.courtsToUse && this.props.courtsToUse.length >= this.props.courts.length) ? this.props.courtsToUse[index] : index + 1} courtClass={this.props.courtClass}
                       importedPlayers={this.props.importedPlayers} round={this.props.roundIndex} playerStats={this.props.playerStats} onPlayerClick={this.props.onPlayerClick}/>
            );
        }
